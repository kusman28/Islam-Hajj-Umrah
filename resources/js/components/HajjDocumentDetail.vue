	...
	<div class="container">
		...
		<img 
            ...
            <hr class="mb-4">  
                ...
                <hr>
                <div class="mb-5">
                    <button class="col-md-4 btn btn-success">Print
						...
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="addNewLabel">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Ticket</a>
                                    </li>
                                    </ul>
                                </h5>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="form-row">
									...
									<select name="type" class="form-control">
										...
										<option value="Qiran">Qiran</option>
										<option value="Ifrad">Ifrad</option>
									</select>
                    				</div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                    				<div class="col-md-4 mb-2">
									<small>Date</small>	
									<input type="date" name="contact_company"
									class="form-control">
									<has-error :form="form" field="contact_company"></has-error>
                    				</div>
                    				<div class="col-md-4 mb-2">
									<small>Time</small>	
									<input type="time" name="contact_company"
									class="form-control">
									<has-error :form="form" field="contact_company"></has-error>
                    				</div>
                                </div>
